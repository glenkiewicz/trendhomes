...
export const MOCKUP_DATA = {
  ...
  navigation: {
    menuItems: [
      ...
      { label: "Stolarka dla biznesu", href: "/stolarka-dla-biznesu", bold: true },
  ...
  home: {
      ...
      slides: [
        {
          ...
          titleLines: ["Okna, drzwi i rolety", "z montażem.", "W Bieszczadach."],
          description:
        ...
        },
        {
          ...
          titleLines: ["Zadbaj o przyszłość już teraz! Dołącz do programu Czyste Powietrze"],
          description:
        ...
        },
        {
          ...
          titleLines: ["Trendhomes dla biznesu", "Stolarka dopasowana do potrzeb inwestycyjnych"],
          description:
    ...
    cleanAir: {
      heading: ["Skorzystaj z dofinansowania", 'w ramach programu "Czyste Powietrze"'],
      description:
    ...
    why: {
      ...
      intro:
        "Przy budowie nowego domu, remoncie mieszkania albo pracy nad lokalem usługowym liczy się coś więcej niż sama stolarka. Klienci wybierają nas, bo łączymy dobry produkt z terminami, porządkiem na budowie i lokalnym serwisem.",
      benefits: [
        {
    ...
    realizations: {
      ...
      images: [
        { src: "/images/real-1.jpg", alt: "Realizacja \u2013 nowoczesny dom" },
        { src: "/images/real-2.jpg", alt: "Realizacja \u2013 dom z pergolą" },
        { src: "/images/real-3.jpg", alt: "Realizacja \u2013 drzwi wejściowe" },
        { src: "/images/real-4.jpg", alt: "Realizacja \u2013 klamka drzwi" },
        { src: "/images/real-5.jpg", alt: "Realizacja \u2013 okna w domu" },
        { src: "/images/real-6.jpg", alt: "Realizacja \u2013 okno z widokiem" },
        { src: "/images/real-7.jpg", alt: "Realizacja \u2013 ściana szklana w biurze" },
      ],
    ...
    faq: {
      ...
      items: [
        ...
        {
          question: "Na jakim etapie budowy najlepiej montować okna i drzwi zewnętrzne?",
          answer:
        ...
        {
          question: "Czy wymiana okien w mieszkaniu naprawdę może odbyć się w 1 dzień?",
          answer:
        ...
        {
          question: "Jak wygląda kwestia kurzu i sprzątania po wymianie okien lub drzwi?",
          answer:
        ...
        {
          question: "Czy stolarka do lokalu usługowego musi spełniać specjalne wymagania?",
          answer:
        ...
        {
          question: "Jak zorganizować montaż stolarki, żeby nie zatrzymać całkowicie pracy lokalu?",
          answer:
        ...
        {
          question: "Czy pod pergolę lub ogród zimowy potrzebny jest specjalny fundament?",
          answer:
        ...
        {
          question: "Czy z pergoli albo ogrodu zimowego można korzystać cały rok?",
          answer:
    ...
    brands: {
      ...
      image: { src: "/images/about-team.jpg", alt: "Zespół Trendhomes w salonie w Sanoku" },
    },
  ...
  pages: {
    ...
    oNas: {
      ...
      about: {
        heading: ["Ludzie od stolarki, którzy", "wolą dowozić niż obiecywać"],
        paragraphs: [
        ...
        image: { src: "/images/onas-team.png", alt: "Zespół Trendhomes" },
      },
      howWeWork: {
    ...
    realizacje: {
      hero: {
        ...
        titleLines: ["Realizacje Trendhomes:", "przestrzeń w najlepszej oprawie"],
        description:
          "Każdy projekt to inny dom, inne mieszkanie i inne potrzeby. Zobacz wybrane realizacje Trendhomes w Sanoku i okolicach \u2013 od nowych domów jednorodzinnych, przez mieszkania w blokach, aż po lokale usługowe i pergole w ogrodzie.",
      },
      newBuilds: {
        ...
        items: [
          { title: "Dom jednorodzinny\nw Sanoku", image: "/images/realizacje-1.jpg" },
          { title: "Dom typu stodoła\nw Zagórzu", image: "/images/realizacje-2.jpg" },
          { title: "Loft w centrum\nSanoka", image: "/images/realizacje-3.jpg" },
          { title: "Dom jednorodzinny\nw Lesku", image: "/images/realizacje-4.jpg" },
          { title: "Dom jednorodzinny\nw Sanoku", image: "/images/realizacje-1.jpg" },
          { title: "Dom typu stodoła\nw Zagórzu", image: "/images/realizacje-2.jpg" },
        ],
      },
      ...
      renovations: {
        ...
        items: [
          { title: "Wymiana okien\nw bloku w Sanoku", image: "/images/realizacje-5.jpg" },
          { title: "Modernizacja stolarki\nw kamienicy", image: "/images/realizacje-6.jpg" },
          { title: "Remont mieszkania\nw Lesku", image: "/images/realizacje-hero.jpg" },
          { title: "Wymiana okien\nw domu jednorodzinnym", image: "/images/realizacje-7.jpg" },
          { title: "Wymiana okien\nw bloku w Sanoku", image: "/images/realizacje-5.jpg" },
          { title: "Modernizacja stolarki\nw kamienicy", image: "/images/realizacje-6.jpg" },
        ],
      },
      products: {
        ...
        image: { src: "/images/realizacje-products.jpg", alt: "Produkty Trendhomes" },
      },
      b2b: {
        heading: ["Realizacje B2B", "od Trendhomes"],
        items: [
          { title: "Lokal usługowy\nw Sanoku", image: "/images/realizacje-5.jpg" },
          { title: "Biurowiec\nw Rzeszowie", image: "/images/realizacje-6.jpg" },
          { title: "Szkoła podstawowa\nw Zagórzu", image: "/images/realizacje-hero.jpg" },
          { title: "Galeria handlowa\nw Sanoku", image: "/images/realizacje-7.jpg" },
          { title: "Lokal usługowy\nw Sanoku", image: "/images/realizacje-5.jpg" },
          { title: "Biurowiec\nw Rzeszowie", image: "/images/realizacje-6.jpg" },
        ],
      },
    ...
    rozwiazania: {
      ...
      pergola: {
        ...
        galleryHeading: ["Zobacz jakie pergole", "stworzyliśmy dla klientów"],
        gallery: [
    ...
    stolarkaForBusiness: {
      ...
      services: {
        heading: ["Stolarka w pełni dopasowana", "do potrzeb Twojej inwestycji"],
        categories: [
          {
      ...
      process: {
        heading: ["Jak wygląda współpraca", "przy stolarce dla biznesu"],
        steps: [
          {
            number: "1.",
      ...
      partner: {
        ...
        image: { src: "/images/biznes-partner.jpg", alt: "Partner w biznesie" },
      },
    },
    ...
    blog: {
      ...
      filters: ["Wszystkie", "Porady", "Inspiracje", "Aktualności", "Technologie"] as const,
    ...
    produktyOkna: {
      ...
      manufacturerFilters: ["Wszystkie", "Salamander", "Rehau", "Aluplast", "EkoSun", "Gealan"],
      manufacturers: [
        {
          id: "salamander",
          name: "Salamander",
    ...
    produktyDrzwi: {
      ...
      why: {
        heading: ["Dlaczego warto zamówić", "drzwi zewnętrzne w Trendhomes"],
        items: [
          {
            icon: "/images/icon-profile.svg",
      ...
      manufacturers: {
        heading: ["Producenci drzwi zewnętrznych,", "z którymi pracujemy"],
    ...
    produktyRolety: {
      ...
      cta: {
        heading: "Szukasz rolet do domu, mieszkania albo lokalu w Sanoku?",
        description:
    ...
    produktyDrzwiTarasowe: {
      ...
      systemTypes: {
        heading: ["Typy systemów przesuwnych,", "które najczęściej stosujemy"],
        description:
    ...
    produktyOknaAluminiowe: {
      ...
      advantages: {
        heading: ["Dlaczego czasem warto wybrać", "aluminium zamiast PVC"],
        items: [
          {
    ...
    produktyDrzwiWewnetrzne: {
      ...
      whyTrendhomes: {
        heading: ["Dlaczego warto zamówić", "drzwi wewnętrzne w Trendhomes"],
        items: [
          {
            icon: "/images/icon-profile.svg",
      ...
      manufacturers: {
        heading: ["Producenci drzwi wewnętrznych,", "z którymi pracujemy"],
        featuresLabel: "Cechy wyróżniające",
        items: [
          {
            id: "erkado",
    ...
    produktyOknaDrewniane: {
      ...
      summary: {
        heading: ["Podsumowanie –", "okna drewniane Naturo i Esperia Life"],
        description:
    ...
    produktyDlaBiznesu: {
      hero: {
        ...
        imageAlt: "Stolarka dla biznesu i obiektów użyteczności publicznej",
        breadcrumbs: ["home", "Produkty", "Dla biznesu"],
        heading: ["Stolarka dla biznesu", "i obiektów użyteczności publicznej"],
        description:
