					...
					<div className="mx-auto max-w-[1440px] px-3 md:px-5">
						...
						<div className="mt-10 space-y-0 md:mt-14">
							{whyTrendhomes.team.map((member, i) => (
								<AnimateOnScroll key={i} delay={i * 100}>
									<div
										className={`grid grid-cols-1 gap-6 border-b border-dark/10 py-6 last:border-b-0 md:gap-10 md:py-8`}
									>
										<div
											className={
												i === 1
										...
										>
											<h3 className="text-xl font-bold text-dark md:text-3xl">
												{member.name}
											</h3>
											<p className="mt-4 text-sm leading-relaxed text-dark md:text-lg">
												{member.text}
