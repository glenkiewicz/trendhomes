...
export type RealizationItem = { title: string; image: string };

export type RealizacjeContentProps = {
  residential: RealizationItem[];
  pergola: RealizationItem[];
  business: RealizationItem[];
};
...
export default function RealizacjeContent({
  ...
  return (
    <>
      ...
      <AnimateOnScroll>
        <ProjectCarousel items={pergola} heading={renovations.heading} />
      </AnimateOnScroll>
      ...
      {/* Realizacje B2B */}
      <AnimateOnScroll>
        <ProjectCarousel items={business} heading={b2b.heading} />
      </AnimateOnScroll>
